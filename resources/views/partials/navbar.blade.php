	...
	<div class="container">
		...
		<div class="navbar-collapse w-100 collapse" id="collapsingNavbar3">
			...
			<ul class="nav navbar-nav ms-auto w-100 justify-content-end">
				...
				@else
					<li class="nav-item">
						<a class="nav-link" href="/login"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
					...
					<li class="nav-item">
						<a class="nav-link" href="/register"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
